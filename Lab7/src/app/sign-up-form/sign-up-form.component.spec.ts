...
describe('SignUpFormComponent', () => {
  ...
  it('invalid email must show apropriate message', () => {
    ...
    fixture.whenStable().then(()=> {
      ...
      expect(emailError).not.toBeNull();
      expect(emailError.textContent).toContain('Email is invalid!!!')
    })
    expect(null).toBeNull();
  });
  ...
  it('short password must show apropriate error message', () => {
    ...
    fixture.whenStable().then(()=> {
      ...
      expect(passwordError).not.toBeNull();
      expect(passwordError.textContent).toContain('Password must be 8 or more characters long')
    })
    expect(null).toBeNull();
  });
  it('show message when password doesn\'t have upper and lower letters, digits and special symbols', () => {
    ...
    fixture.whenStable().then(()=> {
      ...
      expect(passwordError).not.toBeNull();
      expect(passwordError.textContent).toContain('Password must contain at least one of the following: A, a, 1, _')
    }) 
    expect(null).toBeNull();
  });
  ...
  it('empty surname must show that this field is required', () => {
    ...
    fixture.whenStable().then(()=> {
      ...
      expect(surnameError.textContent).toContain('Surname is required')
    })
    expect(null).toBeNull();
  });
  ...
  it('terms of use must be checked to register', () => {
    ...
    fixture.whenStable().then(()=> {
      ...
      expect(termsError.textContent).toContain('You need to accept our terms of use.')
    })
    expect(null).toBeNull();
  });
